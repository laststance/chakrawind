...
by one. All you need to do is install the `@laststance/chakrawind-ui` package:

```sh
$ yarn add @laststance/chakrawind-ui
# or
$ npm install --save @laststance/chakrawind-ui
```
...
```jsx
import { ColorModeProvider, ThemeProvider } from "@laststance/chakrawind-ui"
